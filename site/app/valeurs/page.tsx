...
const banques = [
  { name: "BCV", logo: "/Banque depoositaire/BCV_logo-web.png", alt: "BCV" },
  {
    name: "Lombard Odier",
    logo: "/Banque depoositaire/Lombard_Odier_logo-web.png",
    alt: "Lombard Odier",
  },
  {
    name: "Swissquote",
    logo: "/Banque depoositaire/logo swissquote.png",
    alt: "Swissquote",
  },
  {
    name: "UBP",
    logo: "/Banque depoositaire/logo UBP.png",
    alt: "Union Bancaire Privée",
  },
  { name: "UBS", logo: "/Banque depoositaire/UBS_Logo-web.png", alt: "UBS" },
];
