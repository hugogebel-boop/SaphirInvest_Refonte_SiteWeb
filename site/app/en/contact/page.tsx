...
export const metadata: Metadata = {
  title: "Contact Us",
  description:
    "All contact methods: by email, by phone, by mail. As well as the location of our offices, just steps from the famous Place des Banques: St-François Square in Lausanne.",
};
        ...
        <div className="mx-auto max-w-7xl px-20 md:px-32 lg:px-48">
          <div className="grid gap-8 sm:grid-cols-2">
            <div className="flex items-start gap-4 rounded-lg bg-white p-8 shadow-lg">
              ...
              <div>
                <h2 className="font-heading text-lg font-semibold uppercase tracking-wider text-saphir-blue">Phone</h2>
            ...
            <div className="flex items-start gap-4 rounded-lg bg-white p-8 shadow-lg">
              ...
              <div>
                <h2 className="font-heading text-lg font-semibold uppercase tracking-wider text-saphir-blue">Address</h2>
