...
export const metadata: Metadata = {
  title: "Contact",
  description:
    "Contact Saphir Invest SA in Lausanne, Switzerland. Rue du Grand-Chêne 6, near St-François Square. Phone: +41 21 648 00 16. Independent wealth manager.",
  alternates: {
    canonical: "https://saphir-invest.ch/en/contact/",
    languages: {
  ...
  openGraph: {
    ...
    description:
      "Contact Saphir Invest SA in Lausanne, Switzerland. Rue du Grand-Chêne 6, near St-François Square.",
    url: "https://saphir-invest.ch/en/contact/",
    type: "website",
  },
};
      ...
      <section className="py-4 md:py-6">
        <div className="mx-auto max-w-7xl px-6 sm:px-12 md:px-32 lg:px-44">
          <div className="overflow-hidden rounded-lg shadow-lg">
            <iframe
              src={mapUrl}
              title="Rue du Grand-Chêne 6, Lausanne, Switzerland"
              width="100%"
              height="450"
              style={{ border: 0 }}
              allowFullScreen
        ...
        <div className="mx-auto max-w-7xl px-6 sm:px-12 md:px-32 lg:px-44">
          <div className="grid gap-6 sm:grid-cols-2 sm:gap-8">
            <div className="flex items-start gap-4 rounded-lg bg-white p-6 shadow-lg sm:p-8">
              ...
              <div>
                <h2 className="font-heading text-base font-semibold uppercase tracking-wider text-saphir-blue sm:text-lg">Phone</h2>
            ...
            <div className="flex items-start gap-4 rounded-lg bg-white p-6 shadow-lg sm:p-8">
              ...
              <div>
                <h2 className="font-heading text-base font-semibold uppercase tracking-wider text-saphir-blue sm:text-lg">Address</h2>
