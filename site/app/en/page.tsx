        ...
        <div className="mx-auto grid max-w-7xl grid-cols-1 items-stretch gap-6 px-4 py-8 sm:px-6 md:grid-cols-2 md:gap-8 md:px-12 md:py-16 lg:px-16">
          <div className="order-2 md:order-1">
            <Image
              ...
              alt="Detail of Times Square painting by Louis Magre - golden tones and urban light"
              width={600}
              height={400}
        ...
        <div className="mx-auto grid max-w-7xl grid-cols-1 items-stretch gap-6 px-4 py-8 sm:px-6 md:grid-cols-2 md:gap-8 md:px-12 md:py-16 lg:px-16">
          ...
          <div>
            <Image
              ...
              alt="Detail of Times Square painting by Louis Magre - silhouettes and night atmosphere"
              width={600}
              height={400}
              className="h-48 w-full rounded-lg object-cover shadow-xl sm:h-64 md:h-full"
            />
        ...
        <div className="mx-auto grid max-w-7xl grid-cols-1 items-stretch gap-6 px-4 py-8 sm:px-6 md:grid-cols-2 md:gap-8 md:px-12 md:py-16 lg:px-16">
          <div className="order-2 md:order-1">
            <Image
              ...
              alt="Detail of Times Square painting by Louis Magre - reflections and depth"
              width={600}
              height={400}
              className="h-48 w-full rounded-lg object-cover shadow-xl sm:h-64 md:h-full"
            />
